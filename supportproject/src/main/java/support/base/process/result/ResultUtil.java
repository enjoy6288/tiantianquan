...
import support.base.util.ResourcesUtil;
...
public class ResultUtil {
     ...
     * 创建JSONPObject
     */
    public static JSONObject createJSONPObject(String fileName,int messageCode,int messageType){
    	String message= ResourcesUtil.getValue(fileName, messageCode+"");
    	JSONObject jsonObject = new JSONObject();
    	jsonObject.put("code", messageType);
